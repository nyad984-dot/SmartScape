  ...
  return (
    <footer className="border-t border-slate-200 bg-white/80 backdrop-blur-md">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-4 lg:px-8">
        ...
        <div>
          <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-slate-600">Quick links</h3>
        ...
        <div>
          <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-slate-600">Contact</h3>
          <div className="grid gap-2 text-sm text-slate-500">
